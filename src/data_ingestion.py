...
class DataIngestion:
    ...
    def download_csv_from_gcp(self):
        try:
            ...
            logger.exception(f"Error while downloading CSV from GCP: {e}")
            raise CustomException(f"Failed to download csv file: {e}", e)
...
if __name__ == "__main__":
    os.environ["GOOGLE_APPLICATION_CREDENTIALS"] = r"C:\Users\thoge\Downloads\hidden-phalanx-464505-h0-8c0d7e910ed4.json"
